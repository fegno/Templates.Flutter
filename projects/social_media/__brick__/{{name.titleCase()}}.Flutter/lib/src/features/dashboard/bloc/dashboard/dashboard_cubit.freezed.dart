...
class _$DashboardStateImpl implements _DashboardState {
  const _$DashboardStateImpl({this.navIndex = 0});
  ...
  @override
  String toString() {
    return 'DashboardState(navIndex: $navIndex)';
  }
...
abstract class _DashboardState implements DashboardState {
  const factory _DashboardState({final int navIndex}) = _$DashboardStateImpl;
